...
return {
    ...
    template: 
      '<md-chips ng-model="selected" md-autocomplete-snap md-require-match="true">' +
        '<md-autocomplete md-no-cache="true" md-min-length="0" md-selected-item="selectedSource" md-search-text="searchText" md-items="item in querySearch(searchText)" md-autoselect="true" md-item-text="item.name" placeholder="Click to select source">' +
